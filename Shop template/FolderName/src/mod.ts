...
class SariaShop implements IPreAkiLoadMod, IPostDBLoadMod {
    ...
    constructor() {
        this.mod = "TraderModName"; // Set name of mod so we can log it to console later
    }
    ...
    public postDBLoad(container: DependencyContainer): void {
        ...
        this.addTraderToLocales(tables, baseJson.name, "Name", baseJson.nickname, baseJson.location, "Whatever you want here.");
...
//        traderConfig.durabilityPurchaseThreshhold[baseJson._id] = 60;
    ...
    private registerProfileImage(preAkiModLoader: PreAkiModLoader, imageRouter: ImageRouter): void
    {
        ...
        imageRouter.addRoute(baseJson.avatar.replace(".jpg", ""), `${imageFilepath}/TraderPicName.jpg`);
    }
